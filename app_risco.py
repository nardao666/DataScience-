...
# título
st.title("Sistema de Previsão de Risco do Cliente para Concessão de Empréstimos- By Leonardo Gregorio")
...
#defaultcols = ["Anotação Cadastrais","Índice de Inadiplencia","Classe Renda","Saldo Contas"]
...
st.dataframe(data[cols].head(50))